                ...
                {activeTab === 'tiers' && (
                    <div className="w-11/12 mx-auto">
                        ...
                        <div className="hidden md:flex justify-center mb-8">
                            <div className={`inline-flex rounded-full p-1 ${darkMode ? 'bg-gray-800/70 backdrop-blur-md' : 'bg-white/80 backdrop-blur-md shadow-sm'
                                }`}>
                        ...
                        <div className="md:hidden mb-6">
                            <div className={`grid grid-cols-2 gap-2 ${darkMode ? 'bg-gray-800/70 backdrop-blur-md' : 'bg-white/80 backdrop-blur-md shadow-sm'
                                } rounded-xl p-2`}>
                                {loyaltyTiers.map((tier) => (
                                    <button
                                        key={tier.id}
                            ...
                            {rewardsData.map((reward) => (
                                ...
                                >
                                    <div className="p-6">
                                        ...
                                        <div className={`rounded-lg overflow-hidden ${darkMode ? 'bg-gray-700/50' : 'bg-gray-50/80'
                                            }`}>
                                            <div className={`py-2 px-4 text-sm font-medium ${darkMode ? 'bg-gray-700 text-white' : 'bg-gray-100 text-gray-700'
                                                }`}>
                                                Redemption Options
                                            </div>
                                            <div className="p-3">
                                                {reward.redemptionOptions.map((option, index) => (
                                                    ...
                                                    >
                                                        ...
                                                        <span className={`text-sm font-medium ${darkMode ? 'text-purple-400' : 'text-indigo-600'
                                                            }`}>
                                                            {option.points} pts
                                                        </span>
                                                    </div>
