...
const HowItWorksComponent = () => {
    ...
    return (
        <div id={'how-it-works'} className={`py-32 transition-colors duration-500 relative overflow-hidden ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'
            }`}>
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <div className={`relative w-full rounded-3xl overflow-hidden ${darkMode
                        ...
                        <div className="relative p-6 md:p-8">
                            ...
                            <div className="flex justify-between items-center mb-6">
                                <div className={`px-4 py-2 rounded-full text-sm font-medium ${darkMode
                                        ? 'bg-gray-800/70 text-cyan-300 border border-cyan-800/50'
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                                ...
                                <div className={`relative rounded-2xl overflow-hidden h-48 md:h-64 max-w-full mx-auto ${isTransitioning ? 'opacity-0' : 'opacity-100'
                                    ...
                                    {/* Step Number */}
                                    <div
                                        className={`absolute top-4 right-4 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-bold ${darkMode
                                ...
                                <div className={`md:col-span-2 space-y-4 ${isTransitioning ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'
                                    } transition-all duration-600`}>

                                    {/* Step Title */}
                                    <div className="flex items-center">
                                        <h3 className={`text-2xl md:text-3xl font-bold ${darkMode ? 'text-white' : 'text-white'
                                            }`}>
                                            {steps[activeStep].title}
                                        </h3>
                                        <div className={`ml-4 px-3 py-1 rounded-full text-xs font-medium ${darkMode
                                                ? 'bg-gray-800/70 text-cyan-300 border border-cyan-800/50'
                                                : 'bg-white/30 text-white border border-white/20'
                                            } backdrop-blur-md`}>
                                    ...
                                    <div className="flex gap-4 pt-2">
                                        <button
                                            ...
                                            className={`flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${darkMode
                                                    ? 'bg-gray-800/70 text-white border border-gray-700/50 hover:bg-gray-700/70'
                                ...
                                <div className="relative flex justify-between">
                                    {steps.map((step, index) => (
                                        ...
                                        >
                                            {/* Step Marker */}
                                            <div
                                                className={`w-4 h-4 md:w-6 md:h-6 rounded-full transition-all duration-300 ${index <= activeStep
                                                        ? darkMode
                                                            ? 'bg-cyan-500'
                                                            : 'bg-blue-500'
                                                        : darkMode
                                            ...
                                            <div
                                                className={`absolute -bottom-6 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs font-medium transition-all duration-300 ${index === activeStep
                ...
                <div className="md:hidden">
                    <div className={`rounded-2xl overflow-hidden backdrop-blur-md p-6 ${darkMode
                        ...
                        <div>
                            {steps.map((step, index) => (
                                <div
                                    key={`mobile-${step.id}`}
                                    className={`transition-all duration-500 ${activeStep === index ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 absolute'
                                        }`}
                                ...
                                >
                                    ...
                                    <div className="flex items-center mb-3">
                                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center mr-4 ${darkMode
                                    ...
                                    {/* Key Benefit */}
                                    <div className={`p-3 rounded-xl mb-4 ${darkMode
                                            ? 'bg-gray-800/70 border border-gray-700/50'
                                            : 'bg-white/70 border border-gray-200/50'
                                        } backdrop-blur-md`}>
                                        <div className="flex items-center">
                                            {step.highlightEmoji}
                                            <span className={`ml-2 font-medium text-sm ${darkMode ? 'text-gray-200' : 'text-gray-800'
                                                }`}>
                                                {step.benefit}
                                            </span>
                                        </div>
                                    ...
                                    <div className="flex justify-between">
                                        <button
                                            onClick={handlePrevStep}
                                            className={`flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${darkMode
                ...
                {/* Call to Action */}
                <div className={`mt-12 p-6 md:p-8 rounded-2xl text-center max-w-3xl mx-auto relative overflow-hidden ${darkMode
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <a
                            href="/browse"
                            className={`px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 ${darkMode
