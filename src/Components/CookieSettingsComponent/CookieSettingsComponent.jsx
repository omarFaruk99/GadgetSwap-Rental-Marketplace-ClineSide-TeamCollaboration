...
const CookieSettingsComponent = () => {
    ...
    return (
        <div className={`min-h-screen transition-colors duration-300 ${darkMode ? "bg-gray-900 text-gray-100" : "bg-gray-50 text-gray-900"
            ...
            {/* Cookie Alert */}
            {showAlert && (
                <div className={`fixed bottom-0 left-0 right-0 z-50 p-4 ${darkMode ? "bg-gray-800 border-t border-gray-700" : "bg-white border-t border-gray-200 shadow-lg"
                    }`}>
                    <div className="container mx-auto">
                        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                            <div className="flex items-start">
                                <FiAlertTriangle className={`mt-1 mr-3 flex-shrink-0 ${darkMode ? "text-amber-400" : "text-amber-500"
                                    }`} size={20} />
                                <div>
                                ...
                                {Object.keys(cookieSettings).map((key) => (
                                    <li key={key}>
                                        <button
                                            ...
                                            className={`w-full flex items-center p-3 rounded-lg transition-colors ${expandedSection === key
                                                ? darkMode
                                        ...
                                        >
                                            <span className={`mr-3 ${expandedSection === key
                                                ? darkMode
                                                    ? "text-blue-400"
                                                    : "text-blue-600"
                                                : darkMode
            ...
            <main className="container mx-auto px-4 py-16 pt-32">
                ...
                <div className="max-w-4xl mx-auto">
                    {/* Introduction */}
                    <div className={`p-6 rounded-xl mb-8 transition-colors ${darkMode ? "bg-gray-800" : "bg-white shadow-sm"
                        }`}>
                        <div className="flex items-start">
                            <FiInfo className={`mt-1 mr-4 flex-shrink-0 ${darkMode ? "text-blue-400" : "text-blue-600"
                                }`} size={24} />
                            <div>
                                ...
                                <p className={`mt-4 ${darkMode ? "text-gray-300" : "text-gray-700"}`}>
                                    As a rule, cookies will make your browsing experience better. However, you may prefer to disable cookies on this site and on others. The most effective way to do this is to disable cookies in your browser. We suggest consulting the Help section of your browser or taking a look at the <a href="#" className={`${darkMode ? "text-blue-400 font-semibold hover:underline" : "text-blue-600 font-semibold hover:underline"}`}>About Cookies website</a> which offers guidance for all modern browsers.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 mb-8">
                        {Object.keys(cookieSettings).map((key) => (
                            <div
                                key={key}
                                className={`rounded-xl overflow-hidden transition-colors ${darkMode ? "bg-gray-800" : "bg-white shadow-sm"
                                    }`}
                            >
                                <div className="p-4 sm:p-6">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center">
                                            <span className={`mr-3 ${cookieSettings[key].enabled
                                                ? darkMode
                                                    ? "text-blue-400"
                                                    : "text-blue-600"
                                                : darkMode
                                        ...
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <label className="relative inline-flex items-center cursor-pointer">
                                                ...
                                                />
                                                <div className={`w-11 h-6 rounded-full peer ${cookieSettings[key].mandatory
                                                    ? darkMode
                                                        ? "bg-gray-600"
                                                        : "bg-gray-300"
                                                    : darkMode
                                                    ...
                                                    } peer-focus:outline-none peer-focus:ring-4 ${darkMode
                    ...
                    <div className={`p-6 rounded-xl mb-8 transition-colors ${darkMode ? "bg-blue-900/20 border border-blue-800/30" : "bg-blue-50 border border-blue-100"
                        }`}>
                        <div className="flex items-start">
                            <FiHelpCircle className={`mt-1 mr-4 flex-shrink-0 ${darkMode ? "text-blue-400" : "text-blue-600"
                                }`} size={24} />
                            <div>
                                <h3 className="text-lg font-bold mb-2">Need More Information?</h3>
                                <p className={`${darkMode ? "text-gray-300" : "text-gray-700"}`}>
                                    If you have any questions about our cookie policy or how we handle your data, please visit our <a href="/privacy-policy" className={`${darkMode ? "text-blue-400 font-semibold hover:underline" : "text-blue-600 font-semibold hover:underline"}`}>Privacy Policy</a> page or <a href="/contact-us" className={`${darkMode ? "text-blue-400 font-semibold hover:underline" : "text-blue-600 font-semibold hover:underline"}`}>Contact Us</a>.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={`p-6 rounded-xl transition-colors ${darkMode ? "bg-gray-800" : "bg-white shadow-sm"
                        ...
                        <div className="flex items-start">
                            <FiLock className={`mt-1 mr-4 flex-shrink-0 ${darkMode ? "text-green-400" : "text-green-600"
                                }`} size={24} />
                            <div>
