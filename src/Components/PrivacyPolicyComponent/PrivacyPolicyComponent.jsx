                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1">
                            ...
                            <div className="mb-8">
                                <div className="flex items-center mb-4">
                                    <div className={`p-3 rounded-full mr-4 ${darkMode ? "bg-blue-900/30" : "bg-blue-50"
                                        ...
                                        <FiLock className={`${darkMode ? "text-blue-400" : "text-blue-600"
                                            }`} size={24} />
                                    </div>
                                    <div>
                        ...
                        <div className={`mt-8 p-6 rounded-xl transition-colors ${darkMode ? "bg-gray-800" : "bg-white shadow-sm"
                            ...
                            <div className="flex items-start">
                                <div className={`p-3 rounded-full mr-4 ${darkMode ? "bg-blue-900/30" : "bg-blue-50"
                                    ...
                                    <FiCheckCircle className={`${darkMode ? "text-blue-400" : "text-blue-600"
                                        }`} size={24} />
                                </div>
                                <div>
                        ...
                        <div className={`mt-8 p-6 rounded-xl transition-colors ${darkMode ? "bg-blue-900/20" : "bg-blue-50"
                            ...
                            <div className="flex items-start">
                                <FiEye className={`mr-4 flex-shrink-0 ${darkMode ? "text-blue-400" : "text-blue-500"
                                    }`} size={24} />
                                <div>
                        ...
                        {/* Warning Section */}
                        <div className={`mt-8 p-6 rounded-xl transition-colors ${darkMode ? "bg-amber-900/20" : "bg-amber-50"
                            } border-l-4 ${darkMode ? "border-amber-600" : "border-amber-500"
                            }`}>
                            <div className="flex items-start">
                                <FiAlertTriangle className={`mr-4 flex-shrink-0 ${darkMode ? "text-amber-400" : "text-amber-500"
                                    }`} size={24} />
                                <div>
                                    <h3 className={`text-lg font-bold mb-2 ${darkMode ? "text-amber-400" : "text-amber-700"
                                        }`}>Important Notice</h3>
                                    <p className={`${darkMode ? "text-gray-300" : "text-gray-700"
                                        }`}>
