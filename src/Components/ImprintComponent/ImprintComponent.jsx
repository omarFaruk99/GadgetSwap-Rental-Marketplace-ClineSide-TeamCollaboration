                    ...
                    <div className="flex-1">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className={`p-4 rounded-lg ${
                                    ...
                                    <p className={`${darkMode ? "text-gray-300" : "text-gray-700"}`}>
                                        ...
                                        <a href="mailto:info@gadgetswap.com" className={`${
                                            darkMode ? "text-blue-400 hover:text-blue-300" : "text-blue-600 hover:text-blue-700"
                                        }`}>info@gadgetswap.com</a>
                                    </p>
                                    <p className={`mt-2 ${darkMode ? "text-gray-300" : "text-gray-700"}`}>
                                        For legal matters:<br />
                                        <a href="mailto:legal@gadgetswap.com" className={`${
                                            darkMode ? "text-blue-400 hover:text-blue-300" : "text-blue-600 hover:text-blue-700"
                        ...
                        <div className={`mt-8 p-6 rounded-xl transition-colors ${
                            ...
                            <div className="flex items-start">
                                <FiCheckCircle className={`mr-4 flex-shrink-0 ${
                        ...
                        <div className={`mt-8 p-6 rounded-xl transition-colors ${
                            ...
                            <div className="flex items-start">
                                <FiGlobe className={`mr-4 flex-shrink-0 ${
                                    darkMode ? "text-blue-400" : "text-blue-600"
                                }`} size={24} />
                                <div>
