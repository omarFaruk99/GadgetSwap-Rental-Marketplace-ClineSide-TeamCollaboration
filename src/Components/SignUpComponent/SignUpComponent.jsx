...
const SignUpComponent = () => {
    ...
    return (
        <div
            className={`min-h-[calc(100vh-421px)] flex items-center justify-center py-12 pt-32 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'
                }`}>
            <div className={`max-w-xl w-full space-y-8 relative ${darkMode
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        {/* Full Name Field */}
                        <div>
                            <label htmlFor="fullName" className={`block text-sm font-medium ${darkMode ? 'text-gray-200' : 'text-gray-700'
                                } transition-colors duration-300`}>
                                Full Name
                            </label>
                            <div className="mt-1 relative">
                                ...
                                <input
                                    ...
                                    onBlur={handleBlur}
                                    className={`appearance-none block w-full pl-10 pr-3 py-2 border ${errors.fullName && touched.fullName
                                        ? 'border-red-500'
                                        : darkMode
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    onBlur={handleBlur}
                                    className={`appearance-none block w-full pl-10 pr-10 py-2 border ${errors.confirmPassword && touched.confirmPassword
                                        ? 'border-red-500'
                                        : darkMode
                                            ? 'border-gray-600 bg-gray-700/50 text-white'
                                            : 'border-gray-300 bg-white/80 text-gray-900'
                        ...
                        <div className="flex items-start mb-1">
                            ...
                            <div className="ml-3 text-sm">
                                <label htmlFor="acceptTerms" className={`font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'
                                    } transition-colors duration-300`}>
                                    I accept the <a href="/terms-and-conditions" className={`${darkMode ? 'text-purple-400 hover:text-purple-300' : 'text-indigo-600 hover:text-indigo-500'
